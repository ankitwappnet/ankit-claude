...
<aside class="sidebar-content-right">
	<h5>About Us</h5>
	<p class="text-justify">Discover a seamless blend of convenience and comfort at Hotel Cosmopolitan located in the bustling heart of the city center. Nestled in Navrangpura, Ahmedabad, Hotel Cosmopolitan is a great choice for travelers looking for a 4 star hotel providing facilities equivalent to a 4 star hotel. Our Hotel stands out as one of the highly recommended hotels in Ahmedabad.
...
<?php
if (count($_POST) > 0) {
	$input_name = $_POST["callback-name"];
	$input_email = $_POST["callback-email"];
	$input_country = $_POST["flagcode"];
	$input_phone = $_POST["callback-phone"];
	$emailList = "leads@clientsnow.co.in";
	$headers .= "Bcc: " . $emailList . "\r\n";
	$body = "
		Hi Hotel Cosmopolitan.,
		You have one Callback from,
		...
		Phone =  " . $input_phone . " 
		";
	if (mail("ceo@hotelcosmopolitan.in", "Inquiry", $body, $headers)) {
...
<aside class="sidebar-content-right">
	...
	<form action="" method="post">
		...
		<div class="input-group mb-3 pb-1">
			<input id="flagcode" type="hidden" class="form-control" placeholder="Phone" name="flagcode">
...
<aside class="sidebar-content-right">
	...
	<ul class="list list-icons list-icons-style-2 mt-2">
		<li><i class="fas fa-map-marker-alt top-6"></i> <strong class="text-dark">HEAD OFFICE</strong>
			<p>Darshan Society Road, Near Stadium Circle, Navrangpura, Ahmedabad - 380009
			</p>
		</li>
		<li><i class="fas fa-phone top-6"></i> <strong class="text-dark">PHONE:<br /></strong>
			<p><a href="tel:+919099914802">+91-90-9991-4802 </a> <br>
				<a href="tel:+919099914811">+91-90-9991-4811</a>
			</p>
		</li>

		<li><i class="fas fa-envelope top-6"></i> <strong class="text-dark">Email:</strong>
			<p><a href="mailto:reserve@hotelcosmopolitan.in">reserve@hotelcosmopolitan.in</a></p>
		</li>
	</ul>
</aside>
<aside class="sidebar-content-right">
	<h5>Google Rating <a href="https://g.co/kgs/tVsYPt" target="_blank" rel="noreffer noopener">(4.4/5)</a></h5>
	<i data-star="4.4"></i>
</aside>
